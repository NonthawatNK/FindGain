...
path = "D:\data_mining\Dessiontree\FindGin\L\DisplayL2left.csv"
...
""" info D,Att_1,Att_3,Att_4,Att_5,Att_6,Att_7"""
...
Result_All=[gainAtt1,gainAtt3,gainAtt4,gainAtt5,gainAtt6,gainAtt7]
...
f3=open("D:\data_mining\Dessiontree\FindGin\L\DisplayL3leftleft.csv","w")
f4=open("D:\data_mining\Dessiontree\FindGin\R\DisplayL3leftright.csv","w")

#นับจำนวน Attb ที่คัดออกไปเป็น Root คือ Att 5   I J
n = len(X)
for i in range(0,n):
    if ((X[i].count('I')==1)): 
        f3.write(str(X[i]))

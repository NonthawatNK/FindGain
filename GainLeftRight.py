...
path = "D:\data_mining\Dessiontree\FindGin\R\DisplayL3leftright.csv"
...
""" info D,Att_3,Att_1,Att_6,Att_7"""
...
print("\n***Gain results of left right dataset***")
gianInd = InD 
...
Result_All=[gainAtt3,gainAtt1,gainAtt6,gainAtt7]
...
f3=open("D:\data_mining\Dessiontree\FindGin\L\DisplayL3leftrightleft.csv","w")
f4=open("D:\data_mining\Dessiontree\FindGin\R\DisplayL3leftrightright.csv","w")

#นับจำนวน Attb ที่คัดออกไปเป็น Root คือ Att 1   A B
n = len(X)
for i in range(0,n):
    if ((X[i].count('A')==1)): 
        f3.write(str(X[i]))

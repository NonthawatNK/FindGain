...
path = "D:\data_mining\Dessiontree\mDisplayL2leftleft.csv"
...
print("\n***Gain results of left left dataset***")
gianInd = InD 
...
f7=open("D:\data_mining\Dessiontree\mDisplayL3leftleftleft.csv","w")
f8=open("D:\data_mining\Dessiontree\mDisplayL3leftleftright.csv","w")

#นับจำนวน Attb ที่คัดออกไปเป็น Root คือ Att 3 E F
n = len(X)
for i in range(0,n):
    if ((X[i].count('E')==1)): 
        f7.write(str(X[i]))

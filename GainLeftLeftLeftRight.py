...
path = "D:\data_mining\Dessiontree\mDisplayL4leftleftleftright.csv"
...
print("\n***Gain results of left left left right dataset***")
gianInd = InD 
...
# f3=open("D:\data_mining\Dessiontree\mDisplayL4leftleftleft.csv","w")
# f4=open("D:\data_mining\Dessiontree\mDisplayL4rightleftright.csv","w")

# # #นับจำนวน Attb ที่คัดออกไปเป็น Root คือ Att 4 I J
# n = len(X)
# for i in range(0,n):
#     if ((X[i].count('I')==1)): 
#         f3.write(str(X[i]))
